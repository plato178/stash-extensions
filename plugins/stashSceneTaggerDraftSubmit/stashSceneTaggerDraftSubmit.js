    ...
    async function initDraftButtons() {
        ...
        for (const button of buttons) {
            ...
            submitButton.addEventListener('click', async () => {
                const selectedStashbox = document.getElementById('scraper');
                const selectedStashBoxUrl = selectedStashbox.selectedOptions[0].value;
                if (!selectedStashBoxUrl.startsWith('stashbox:')) {
